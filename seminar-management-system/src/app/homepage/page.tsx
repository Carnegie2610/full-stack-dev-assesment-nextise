...
const Courses = async () => {
	...
	// State to hold the selected trainer
	// Handler for selecting a trainer from the dropdown
						...
						{courses.map((course) => (
							<tr key={course.id}>
								...
								<td className="py-3 px-4 border-b">
									{format(new Date(course.date), "MMMM dd, yyyy")}
								</td>
									...
									{course.trainer ? (
										...
										<form action={AssignTrainer}>
											<div className="flex items-center space-x-2">
												<select
													className="border bg-gray-800 border-gray-300 px-4 py-2 rounded-lg shadow-md"
													name="trainerid">
